...
def can_rearrange_orders(order1, order2):
    ...
    is_identical = can_rearrange_orders(order1.left,order2.left) and can_rearrange_orders(order1.right,order2.right)
    is_mirrored = can_rearrange_orders(order1.left,order2.right) and can_rearrange_orders(order1.right,order2.left)

    return is_identical or is_mirrored
